package vn.edu.tgu.config.timezone;

import vn.edu.tgu.QuanlyxuatanApp;
import vn.edu.tgu.repository.timezone.DateTimeWrapper;
import vn.edu.tgu.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = QuanlyxuatanApp.class)
